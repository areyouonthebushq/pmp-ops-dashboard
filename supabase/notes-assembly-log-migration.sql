...
COMMENT ON COLUMN jobs.notes_log IS 'Append-only log: [{text, person, timestamp, assetLabel?, assetKey?, attachment_url?, attachment_name?, attachment_type?, attachment_thumb?}, ...]. Latest also in notes.';
